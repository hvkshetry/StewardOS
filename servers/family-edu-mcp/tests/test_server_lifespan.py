"""Regression tests for family-edu server startup lifecycle."""
...
async def test_lifespan_initializes_and_closes_pool(monkeypatch):
    ...
    monkeypatch.setattr(server_module.asyncpg, "create_pool", fake_create_pool)
    ...
    assert migration_calls[0][1]["migration_table"] == "family_edu.schema_migrations"
